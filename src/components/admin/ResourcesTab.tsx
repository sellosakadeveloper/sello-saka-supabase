...
const RESOURCE_TYPES = ["Article", "Guide", "Screening Info", "FAQ"] as const;
...
const ResourcesTab = () => {
  ...
  const resources = useQuery(api.admin.listResources) as Resource[] | undefined;
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      setFormData((current) => ({
        ...
        file_storage_id: uploaded.storageId,
      }));
      toast({
        title: "Success",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const resourceData = {
        ...
        file_storage_id: formData.file_storage_id || undefined,
      };
      ...
      toast({
        title: "Error",
        description: `Failed to ${editingId ? "update" : "add"} resource`,
        variant: "destructive",
      });
    }
  };
  ...
  const handleEdit = (resource: Resource) => {
    ...
    setFormData({
      ...
      file_storage_id: resource.file_storage_id || "",
    });
    setShowForm(true);
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await deleteResource({ id: id as never });
      toast({
        title: "Success",
  ...
  if (resources === undefined) {
    return (
      <Card className="bg-white">
        <CardContent className="py-8 text-center text-gray-500">Loading resources...</CardContent>
      </Card>
    );
  }
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input type="hidden" value={formData.file_url} />
                </div>
