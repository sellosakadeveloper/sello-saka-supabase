export type CompetitionTicketTemplateData = {
...
function buildTicketMarkup(details: CompetitionTicketTemplateData): string {
  return `
...
export function buildCompetitionTicketEmailHtml(details: CompetitionTicketTemplateData): string {
  return buildTicketMarkup(details);
}

export function buildCompetitionTicketPdfDocumentHtml(details: CompetitionTicketTemplateData): string {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
